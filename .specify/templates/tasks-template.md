...
- [ ] TXXX UX consistency review across touched interfaces
- [ ] TXXX Observability and logging updates for changed behavior
...
- Include tasks for docs, observability, UX consistency, and performance
  validation when the change touches those concerns
